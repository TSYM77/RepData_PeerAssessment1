...
#### to add misisng vlaues I created a sepperate dataframe with all missing values then inserted
#### avg for each interval them merged with dataframe containing records with values
...
####Average stepes increases on Weekends
